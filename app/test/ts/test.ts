...
function restriction<T extends {}>(restriction:restrictionType) {
    
    return (target:any,propertyKey:String,descriptor:PropertyDescriptor)=>{
        console.log(restriction)
    } 
    // return function (target:any,propertyKey:String,descriptor:PropertyDescriptor,restriction:restrictionType) {
        
    //     switch (restriction) {
    //         case restrictionType.none:
    //             console.log(target)
    //         break;
    //         case restrictionType.usingDatabase:
    //             console.log('a')
    //         break;
    //         case restrictionType.usingCompiler:
    //         break;
    //     }
    // };
}
...
class bin {
    ...
    private abcd(...args:any[]):void
    {
        console.log("normal")
    }

    public efg(...args:any[]):string
    {
        console.log(args)
        return "a"
    }
