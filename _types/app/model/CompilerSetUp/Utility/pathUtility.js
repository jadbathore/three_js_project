...
(() => {
    ...
    _a.linkFile = path.join(process.cwd(), 'app', 'public', 'versionning', 'linkfile.cjs');
    ...
    _a.viewerPathName = path.join(process.cwd(), 'app', 'public', 'wasm_mod', 'viewer');
    _a.keySLL = path.join(process.cwd(), 'SSLcredential', 'key.pem');
    _a.certSLL = path.join(process.cwd(), 'SSLcredential', 'cert.pem');
    _a.wasmFile = path.join(process.cwd(), 'app', 'public', 'wasm_mod', 'pkg', 'wasm_mod.js');
})();
